...
humanoid_server=localhost:50405
...
if [ -z "$tested" ]; then
    ...
    # HUMANOID
    timeout 3600s droidbot -d emulator-$3 -a $root_path/apps/$1.apk -interval 2 -count 600 -policy dfs_greedy -grant_perm -keep_env -random -is_emulator -humanoid $humanoid_server -o $root_path/out$out_tester/$1/droidbot_out &
